...
# Fetch Supabase credentials from system environment variables
...
if "your-project-id" in SUPABASE_URL:
    print("Error: Please update your SUPABASE_URL and SUPABASE_KEY strings inside the code.")
    sys.exit(1)

# Connect directly to the database engine bypassing the heavy wrapper
